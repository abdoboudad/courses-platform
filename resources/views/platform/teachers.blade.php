      ...
      @forelse ($teachers as $teacher)
         <div class="box">
            <div class="tutor">
               ...
               <div>
                  <h3>{{ $teacher->name }}</h3>
                  <span>{{ $teacher->categorie }}</span>
               </div>
            </div>
            <p>total playlists : <span>{{ $teacher->users->courses->count() }}</span></p>
            <p>total videos : <span>18</span></p>
            <p>total likes : <span>1208</span></p>
            <a href={{ route('platform.profile',$teacher->users->id) }} class="inline-btn">view profile</a>
         </div>
      @empty
